;var CesiumHeatmapGL = (function(Cesium,createWebGLHeatmap){
    ...
    CHGL.prototype.loadGeojson = function(url){
        getJSON(url,function(data){
            ...
            heatmapcanvas.style.top="-1000px";
            heatmapcanvas.style.left="-1000px"; //此处是为了防止非全屏看得见，将其移除视野
            heatmapcanvas.width = 1000;
            document.body.style.overflow="hidden";//此处是为了防止非全屏看得见，将其移除视野
            // heatmapcanvas.classList.add("hideCanvas");
